...
object Application {
  ...
  val latestScalaCheckPlusVersion = "3.2.8.0"
  ...
  val latestPlusScalaCheckDoc = "plus-scalacheck-1.15/3.2.8.0"
  val latestPlusEasyMockDoc = "plus-easymock-3.2/3.2.8.0"
  val latestPlusJMockDoc = "plus-jmock-2.8/3.2.8.0"
  val latestPlusMockitoDoc = "plus-mockito-3.4/3.2.8.0"
