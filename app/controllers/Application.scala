...
object Application extends Controller {
  ...
  val milestoneVersion = "3.0.0-RC1"
  val milestoneJar = "https://oss.sonatype.org/content/groups/public/org/scalatest/scalatest_2.11/3.0.0-RC1/scalatest_2.11-3.0.0-RC1.jar"
  val latestJar = "https://oss.sonatype.org/content/groups/public/org/scalatest/scalatest_2.11/2.2.6/scalatest_2.11-2.2.6.jar"
  val milestoneScaladoc = "http://www.artima.com/docs-scalatest-3.0.0-RC1"
  val milestoneScalacticScaladoc = "http://www.artima.com/docs-scalactic-3.0.0-RC1"
