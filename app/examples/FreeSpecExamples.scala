...
object FreeSpecExamples extends StyleTraitExamples {
  ...
  val seleniumExample: String =
    """<span class="stImport">import org.scalatest._
      ...
      |<span class="stReserved">class</span> <span class="stType">BlogSpec</span> <span class="stReserved">extends</span> <span class="stType">FreeSpec</span> <span class="stReserved">with</span> <span class="stType">WebBrowser</span> {
