...
object WordSpecExamples extends StyleTraitExamples {
  ...
  val exampleUsage: String =
    """<span class="stImport">import org.scalatest._</span>
      |<span class="stImport">import wordspec._</span>
      |
      |<span class="stReserved">class</span> <span class="stType">SetSpec</span> <span class="stReserved">extends</span> <span class="stType">AnyWordSpec</span> {
      ...
      |  <span class="stLiteral">"A Set"</span> can { <span class="stExplain">// All tests within these curly braces are about "A Set"</span>
      |
      |    <span class="stExplain">// Can describe nested scopes that "narrow" its outer scopes</span>
      |    <span class="stLiteral">"empty"</span> should { <span class="stExplain">// All tests within these curly braces are about "A Set (when empty)"</span>
      |
      |      <span class="stLiteral">"have size 0"</span> in {    <span class="stExplain">// Here, 'it' refers to "A Set (when empty)". The full name</span>
      ...
      |      }
      |      <span class="stLiteral">"produce NoSuchElementException when head is invoked"</span> in { // <span class="stExplain">Define another test</span>
      |        intercept[<span class="stType">NoSuchElementException</span>] {
      |          <span class="stType">Set</span>.empty.head
      |        }
      |      }
      |      <span class="stLiteral">"should be empty"</span> ignore { <span class="stExplain">// To ignore a test, change 'it' to 'ignore'...</span>
      ...
      |    <span class="stLiteral">"non-empty"</span> should { <span class="stExplain">// All tests within these curly braces are about "A Set (when non-empty)"</span>
      |
      |      <span class="stLiteral">"have the correct size"</span> in { <span class="stExplain">// Here, 'it' refers to "A Set (when non-empty)". This test's full</span>
      ...
      |      <span class="stLiteral">"be non-empty"</span> taggedAs (<span class="stType">Slow</span>) in { <span class="stExplain">// Tag a test by placing a tag object after the test name</span>
      ...
      |}
      |
      |<span class="stExplain">// Can also pass fixtures into tests with FixtureAnyWordSpec</span>
      |<span class="stReserved">class</span> <span class="stType">StringSpec</span> <span class="stReserved">extends</span> <span class="stType">FixtureAnyWordSpec</span> {
      ...
      |    }
      |  }
      |  <span class="stLiteral">"The passed fixture"</span> can {
      |    <span class="stLiteral">"be used in the test"</span> in { s =&gt; <span class="stExplain">// Fixture passed in as s</span>
      ...
      |<span class="stReserved">class</span> <span class="stType">InvisibleSpec</span> <span class="stReserved">extends</span> <span class="stType">AnyWordSpec</span> { <span class="stBlockComment">/*code omitted*/</span> }
      |
      |@Ignore <span class="stExplain">// Ignore all tests in a test class</span>
      |<span class="stReserved">class</span> <span class="stType">IgnoredSpec</span> <span class="stReserved">extends</span> <span class="stType">AnyWordSpec</span> { <span class="stBlockComment">/*code omitted*/</span> }
      |
      |<span class="stImport">import tags.Slow</span>
      |@Slow <span class="stExplain">// Mark all tests in a test class with a tag</span>
      |<span class="stReserved">class</span> <span class="stType">SlowSpec</span> <span class="stReserved">extends</span> <span class="stType">AnyWordSpec</span> { <span class="stBlockComment">/*code omitted*/</span> }
      |""".stripMargin
  ...
  val seleniumExample: String =
    """<span class="stImport">import org.scalatest._
      ...
      |<span class="stReserved">class</span> <span class="stType">BlogSpec</span> <span class="stReserved">extends</span> <span class="stType">WordSpec</span> <span class="stReserved">with</span> <span class="stType">WebBrowser</span> <span class="stReserved">with</span> <span class="stType">HtmlUnit</span> {
